...
abstract class $MemoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String content, DateTime createdAt, bool isBookmark});
}
...
class _$MemoImpl implements _Memo {
  ...
  @override
  String toString() {
    return 'Memo(id: $id, content: $content, createdAt: $createdAt, isBookmark: $isBookmark)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, content, createdAt, isBookmark);
...
abstract class _Memo implements Memo {
  const factory _Memo(
      ...
      required final bool isBookmark}) = _$MemoImpl;
