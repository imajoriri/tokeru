...
part 'select_todo_down_action.g.dart';

/// 選択中のTodoを1つ下に移動する[Intent]
class SelectTodoDownIntent extends Intent {
  const SelectTodoDownIntent();
}

@riverpod
SelectTodoDownAction selectTodoDownAction(SelectTodoDownActionRef ref) =>
    SelectTodoDownAction(ref);

class SelectTodoDownAction extends CustomAction<SelectTodoDownIntent> {
  SelectTodoDownAction(this.ref);
  final Ref ref;

  @override
  Object? invoke(covariant SelectTodoDownIntent intent) {
